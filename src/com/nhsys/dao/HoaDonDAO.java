...
public class HoaDonDAO extends NHDAO<HoaDon, Integer> {
    ...
    String UPDATE_SQL = "UPDATE HoaDon SET NgayTao=?, MaNV=?, MaBan=?, TongTien=?,TrangThai=? where MaHD = ?";
    ...
    public void insert(HoaDon entity) {
        try {
            XJdbc.update(INSERT_SQL, entity.getNgayTao(), entity.getMaNV(), entity.getMaBan(), entity.getTongTien(), entity.getTrangThai());
        } catch (Exception ex) {
    ...
    public void update(HoaDon entity) {
        try {
            XJdbc.update(UPDATE_SQL, entity.getNgayTao(), entity.getMaNV(), entity.getMaBan(), entity.getTongTien(), entity.getTrangThai(), entity.getMaHD());
        } catch (Exception ex) {
            Logger.getLogger(HoaDonDAO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
"from HoaDon HD inner join NHANVIEN NV on HD.MaNV = NV.MaNV order by NgayTao asc";
    ...
    public void updateTT(HoaDon entity) {
        try {
            XJdbc.update(UPDATE_TT, entity.getTrangThai(), entity.getTongTien(), entity.getMaHD());
        } catch (Exception ex) {
            Logger.getLogger(HoaDonDAO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
